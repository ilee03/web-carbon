...
function renderPage() {
    ...
    // Analyze the current page for CO2e emissions
    bg.analyzePage(function (totalCO2e) {
        var emissionsDisplay = document.getElementById('emissions-display'); // Create an element in your popup to show this
        emissionsDisplay.innerHTML = `Estimated CO2e emissions for this page: ${formatCarbonWeight(totalCO2e)}`;
    });
